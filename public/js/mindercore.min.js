 ...
 * Copyright (c) 2016 Baidu FEX; Licensed MIT12
 * ====================================================
 */
			...
			k.STATE_NORMAL = h, k.STATE_ACTIVE = j, k.STATE_DISABLED = i, e.extendClass(f, {
				...
				execCommand: function(a) {
					...
					return b = this._getCommand(a), e = {
						...
						(this._hasEnterExecCommand ? (d = b.execute.apply(b, [h].concat(f)),
						this._hasEnterExecCommand || this._interactChange()) : (this._hasEnterExecCommand = !0, c = this._fire(new g("beforeExecCommand", e, !0)),
						c || (this._fire(new g("preExecCommand", e, !1)),
						...
						b.isContentChanged() && this._firePharse(new g("contentchange")),
							this._interactChange()),
							// console.log(this._interactChange()),
		...
		value: function(a, c, d) {
			...
			g.registerInitHook(function() {
				...
				select: function(a, b) {
					...
					a = f.isArray(a) ? a : [a], a.forEach(function(a) {
						-1 === d._selectedNodes.indexOf(a) && d._selectedNodes.unshift(a)

						// 将选中节点的文本添加到数组中
						selectedTexts.push(a.data.text);
					});

					// 打印选中节点的文本数组
					// console.log(selectedTexts);

					return this.renderChangedSelection(c), this;
				},
				...
				return {
					...
					events: {
						...
						"normal.keydown": function(a) {
							...
							for (var d = 1; 10 > d; d++){
								a.isShortcutKey("Alt+" + d) && this.execCommand("expandtolevel", d)
							}
							}
						}
					},
		...
		value: function(a, c, d) {
			function e(a, b, c) {
				...
				function e(a, b) {
					...
					for (var c = [], d = [], e = [], f = 0, g = a.length; f < g; f++) switch (a[f]) {
						case "M":
						case "L":
						case "T":
						case "S":
				...
				function f(a, b, c) {
					if (a && "defs" !== a.tagName) {
						...
						if (a.children)
							for (var k = 0, l = a.children.length; k < l; k++) f(a.children[k], b, c)
					}
				}
				a.style.visibility = "hidden", f(a, b || 0, c || 0), a.style.visibility = "visible"
			}
			b.r(12).registerProtocol("svg", d.exports = {
